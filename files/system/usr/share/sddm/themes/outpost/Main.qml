...
Item {
    ...
    readonly property color outpostAccent: Qt.colorEqual(config.color, "transparent")
    ? "#4c607a"
    : config.color
    ...
    Kirigami.Theme.highlightColor: outpostAccent
    Kirigami.Theme.focusColor: outpostAccent
